...
The repository begins with a pure-Java animated wallpaper baseline. It intentionally has no native libraries, which avoids the original APK's ARM32-only and 4 KB ELF-page constraints. Fold-specific behavior and visual fidelity remain to be tested and refined on hardware.
